...
PATH=$HOME/bin:$HOME/.local/bin:${ASDF_DATA_DIR:-$HOME/.asdf}/shims:/usr/local/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/Users/nbrubake/Library/Python/3.11/bin:$PATH
